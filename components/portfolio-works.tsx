...
export function PortfolioWorks() {
  ...
  return <section id="work" className="portfolio-work portfolio-real-work" aria-labelledby="work-title">
    <div className="portfolio-section-heading"><p className="portfolio-label">01—04 / SELECTED WORK</p><h2 id="work-title">四件作品。<br />一鍵，直接體驗。</h2><p>以下皆為可操作的概念作品，預覽圖取自實際網站。點擊圖片或「進入網站」即可直達；管理系統為本機資料示範，無真實交易。</p></div>
    ...
    <div className="portfolio-real-grid">{projects.map(p => <article className="portfolio-real-card" id={`project-${p.number}`} key={p.number}>
