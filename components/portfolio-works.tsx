...
const projects = [
  ...
  { number: "06", title: "ShareFlow", subtitle: "廣告收入 · 合作夥伴分潤台", type: "REVENUE SHARING SYSTEM", image: "work-shareflow-preview.webp", href: "/shareflow/", admin: "/shareflow/admin/", description: "把多個廣告來源、收入調整與合約比例收進同一個後台。合作夥伴可查看營收與結算進度，管理員則能同步資料、調整分潤與管理權限。", tags: ["API 收入整合", "自動分潤", "權限管理"] },
];
