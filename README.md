...
個人作品集網站，聚焦互動前端、產品系統與流程自動化。首頁以 01–06 編號展示六個可瀏覽、可互動的概念作品，使用實際網站截圖，並提供前台、管理台與會員空間的直接入口。
...
ShareFlow 是廣告業分潤系統 MVP 概念展示，包含合作夥伴登入、廣告收入與調整明細、自動分潤試算、結算紀錄、API 同步回饋、客戶帳號狀態及角色權限。示範操作只存在目前頁面，未串接真實廣告帳戶或正式身分驗證。
