    ...
    <main>
      ...
      <section className="bg-chalk px-5 py-24 text-ink md:px-12 md:py-36">
        <div className="mx-auto grid max-w-[1500px] gap-12 lg:grid-cols-[.8fr_1.2fr] lg:gap-24">
          <div className="flex flex-col justify-between">
            ...
            <Link className="link-arrow mt-12 w-fit" href="/ingredients">
              查看島嶼原料 <ArrowUpRight size={17} />
            </Link>
          </div>
          <figure className="image-frame aspect-[16/10] overflow-hidden bg-stone-900">
            <Image src="/images/island-botanicals.png" alt="雨後岩石上的檜木、茶葉與蘭花" fill className="object-cover transition-transform duration-1000 hover:scale-[1.02]" sizes="(max-width: 1024px) 100vw, 60vw" />
          </figure>
        </div>
      </section>
      ...
      <section className="grid min-h-[90svh] bg-stone-950 text-chalk lg:grid-cols-2">
        <figure className="relative min-h-[62svh] overflow-hidden">
          <Image src="/images/coast-bottle.png" alt="海霧岩岸上的 O-01 香水瓶" fill className="object-cover" sizes="(max-width: 1024px) 100vw, 50vw" />
        </figure>
        <div className="flex flex-col justify-between px-5 py-14 md:px-12 md:py-16 lg:px-16 lg:py-20">
          ...
          <Link className="link-arrow w-fit" href="/collections/o-01">進入香氣檔案 <ArrowUpRight size={17} /></Link>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1500px]">
          ...
          <div className="mt-8 grid items-end gap-12 lg:grid-cols-[1fr_.5fr]">
            ...
            <div>
              ...
              <Link className="link-arrow mt-8 w-fit" href="/story">閱讀品牌故事 <ArrowUpRight size={17} /></Link>
            </div>
          </div>
        </div>
      </section>
